...
class ExpectSpan2
{
    ...
    public function expectParent(Span|ExpectSpan2|string $expectedSpan): self
    {
        $id = match (true) {
            $expectedSpan instanceof Span => $expectedSpan->spanId,
            $expectedSpan instanceof ExpectSpan2 => $expectedSpan->span['spanId'],
    ...
    public function expectSpanEvent(
        ...
        return new ExpectSpanEvent2($this->span['events'][$index]);
    }
